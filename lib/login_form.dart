...
class _Login_formState extends State<Login_form> {
  ...
  Future<void> getData() async {
    ...
    print("user name ${_prefs.getString('username')}");
    print("password ${_prefs.getString('password')}");
    ...
    Future.delayed(
      ...
      (() async {
        if (username != null && password != null) {
          ...
          FirebaseUser user = await _auth.loginEmailandpass(username, password);
  ...
  String pic =
      'https://firebasestorage.googleapis.com/v0/b/m3aak-304801.appspot.com/o/app%20pic%2Fuser.png?alt=media&token=7b4f2261-86d1-49a6-ae1c-58da7b0bbb5b';
  String idspic =
      'https://firebasestorage.googleapis.com/v0/b/m3aak-304801.appspot.com/o/app%20pic%2F126-1266771_add-clip-art-download.png?alt=media&token=d515cf3f-1d7b-48d8-9a9e-41cb6ea9d9b5';
    ...
    if (validateandsave()) {
      try {
        if (_formtype == FormType.login) {
          ...
          FirebaseUser user =
              await _auth.loginEmailandpass(_username, _password);
          Navigator.pushReplacementNamed(
            context,
            '/home',
            arguments: {
          ...
          FirebaseUser user =
              await _auth.registerEmailandpass(_username, _password);
